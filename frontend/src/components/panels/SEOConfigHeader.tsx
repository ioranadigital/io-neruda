    ...
    <div className="px-6 py-4 bg-white border border-gray-200 shadow-sm rounded-lg">
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="border-l-4 border-green-500 pl-3">
          <h3 className="font-bold text-gray-800 text-sm mb-3">🎯 Enfoque Estratégico</h3>
        ...
        <div className="border-l-4 border-orange-500 pl-3">
          <h3 className="font-bold text-gray-800 text-sm mb-3">📐 Estructura del DOM</h3>
        ...
        <div className="border-l-4 border-red-500 pl-3">
          <h3 className="font-bold text-gray-800 text-sm mb-3">🚫 Filtros Antirrobot</h3>
